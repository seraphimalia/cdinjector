...
class CDInjector {
    ...
    async processIncludeDirectives(originalScript, originalScriptFileName) {
        ...
        while ((result = includeDirective.exec(originalScript)) !== null) {
            ...
            if (!visitedScripts.has(scriptFileName)) {
                ...
                if (scriptContent) {
                    originalScript = CDInjector.spliceString(originalScript, startIndex, endIndex, scriptContent);
                    ...
                    // script not found
                    originalScript = CDInjector.spliceString(originalScript, endIndex, endIndex,
    ...
    updateInterface(tabId) {
        ...
        const title = `CDInjector (${count === 0 ? "no" : countStr} script${count === 1 ? "" : "s"} loaded)`;
